...
set SERVER=mapping-server
set "MAPPING_OPTS=%MAPPING_OPTS% -Dmapping.home=%BASE_DIR%"
set "MAPPING_OPTS=%MAPPING_OPTS% -Dclient.json=%BASE_DIR%\conf\client.json"
...
set COMMAND="%JAVA%" %MAPPING_JVM_OPTS% %MAPPING_OPTS% %MAPPING_CONFIG_OPTS% %MAPPING_LOG4J_OPTS% mapping.server %*
