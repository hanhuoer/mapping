...
echo "mapping client is starting..."
...
nohup $JAVA ${JAVA_OPT} mapping.client >> ${BASE_DIR}/logs/start.out 2>&1 &
echo "mapping client is starting, you can check the ${BASE_DIR}/logs/start.out"
